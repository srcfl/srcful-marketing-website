...
export default function UtilitiesPage() {
  ...
  const benefitKeys = [
    ...
    { key: "coordinationFailures", icon: Shield, color: "text-primary", bgColor: "bg-primary/10" },
  ...
  const stats = [
    ...
    { value: "200ms", labelKey: "ourResponse", color: "text-primary" },
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <FadeIn delay={0.2}>
                <Card className="bg-primary/5 border-primary/20">
                  <CardHeader>
                    <CardTitle className="text-primary">{t("problem.partnerships.title")}</CardTitle>
                  </CardHeader>
                  <CardContent>
