...
category: latest
featuredImage: "https://framerusercontent.com/images/Kq2jAtpAYQzNygvv6ODbLw9ZEUQ.png?width=3452&amp;height=1910"
...
curl -o**Live Component Previews**: Interactive demonstrations showing real energy management scenarios—sites monitoring, savings calculations, EV charging status, weather-adjusted forecasting, and dynamic electricity pricing displays.
